...
## 次のClaudeへ：このファイルで種の追加・修正ができます

> **このファイルは診断ツール（`shindan/species.js`）より広い参照表です。**
> 診断に載せていない実在種、亜種や産地バリエーション、交雑個体・色変個体、
> 「クーター」のような総称行も記録しています。
...
| カントンクサガメ | Mauremys nigricans | M | 入門〜中級 | CITES III | 独立種（旧 Chinemys nigricans）・IUCN EN・国内CB確認済み |
...
| ウンキュウ | Mauremys japonica × reevesii | M | 中級 | なし | 交雑種・野外放流厳禁 |
...
| アカアシリクガメ | Chelonoidis carbonarius | L | 中〜上級 | CITES II | 雑食性・南米産 |
| チェリーヘッドアカアシリクガメ | Chelonoidis carbonarius | L | 中〜上級 | CITES II | 頭部が赤い流通名。種としてはアカアシリクガメと同一 |
...
| ビルマホシガメ | Geochelone platynota | M | 上級 | CITES I | 商業輸入不可・診断除外 |
| マダガスカルクモノスガメ | Pyxis arachnoides | S | 上級 | CITES I | 商業輸入不可・診断除外 |

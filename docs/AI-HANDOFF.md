...
| 項目 | 値 |
|------|-----|
| 基準 | `origin/main` = **1dbd158**（rakuten 日次同期・2026-09-08 実測値） |
...
> **N31 は KEEP BOTH で確定・CLOSE した（2026-09-07）。両ページを維持する。**
> 再判定・再比較・canonical 統合の再検討はしない。旧「20表示以上」分岐表は SUPERSEDED。

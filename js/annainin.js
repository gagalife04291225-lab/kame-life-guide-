...
(function () {
  ...
  var CONNECTORS = {
    ...
    speciesList: { label: '種類一覧を見る（118種）', href: '../species-list.html' },
  ...
  var RESPONSE_BUILDERS = {
    ...
    recommended_species: function () {
      ...
      var lede = names
        ...
        : '暮らし方によっておすすめは変わります。';
      return {
        reply: lede + 'ただし「おすすめ」は飼育スペース・予算・臭いへの許容度によって変わるため、診断ツールで具体的な条件を入れると、118種の中からあなたに合う種類を絞り込めます。種類一覧を眺めながら比較するのもおすすめです。',
        quickReplies: ['診断してみる', '種類一覧を見る'],
        linkedFeatures: [CONNECTORS.diagnosis, CONNECTORS.speciesList]
      };
    },

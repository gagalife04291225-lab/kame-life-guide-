...
const PRODUCTS = {
  ...
  media_eheim_2211_coarse: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B004WI1I02?tag=kamelife09-22',
    asin: 'B004WI1I02',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_2211_fine: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B004WI1I1G?tag=kamelife09-22',
    asin: 'B004WI1I1G',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_2213_coarse: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B004WI233I?tag=kamelife09-22',
    asin: 'B004WI233I',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_2213_fine: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B004FLGIGK?tag=kamelife09-22',
    asin: 'B004FLGIGK',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_2213_carbon: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B004WI234M?tag=kamelife09-22',
    asin: 'B004WI234M',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_2215_coarse: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B0014FKJNS?tag=kamelife09-22',
    asin: 'B0014FKJNS',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_2215_fine: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B0014FIOLM?tag=kamelife09-22',
    asin: 'B0014FIOLM',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_2217_fine: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B00E0GLA04?tag=kamelife09-22',
    asin: 'B00E0GLA04',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_substrat_pro_1l: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B005G0OUSW?tag=kamelife09-22',
    asin: 'B005G0OUSW',
    image: '/assets/products/placeholder.webp',
  ...
  media_eheim_mech_1l: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B075VM8C5P?tag=kamelife09-22',
    asin: 'B075VM8C5P',
    image: '/assets/products/placeholder.webp',
  ...
  media_gex_6090_set: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B076MDP7WD?tag=kamelife09-22',
    asin: 'B076MDP7WD',
    image: '/assets/products/placeholder.webp',
  ...
  media_gex_2045_set: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B077N2ZDLN?tag=kamelife09-22',
    asin: 'B077N2ZDLN',
    image: '/assets/products/placeholder.webp',
  ...
  media_fluval_fx_biofoam: {
    ...
    tier: 'standard',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B00D6DRSK8?tag=kamelife09-22',
    asin: 'B00D6DRSK8',
    image: '/assets/products/placeholder.webp',
  ...
  waterdish_zoomed_ramp_bowl: {
    ...
    tier: 'budget',
    priceRange: '',
    affiliateUrl: 'https://www.amazon.co.jp/dp/B00167XQLG?tag=kamelife09-22',
    asin: 'B00167XQLG',
    image: '/assets/products/placeholder.webp',
    why: 'スロープ付きで歩いて入れる浅型の水入れ（外寸 約25.4×20.4×高さ5.8cm・販売店表記）。用途は飲み水と浅い水浴び。内寸は未確認のため、全身が入るのは甲長10cm前後までの幼体〜亜成体と見込む（推定）。甲長15cm以上の成体は飲み水・部分浴用として使い、全身浴には別途大きな容器を用意する',
    rating: 4.0,
    badge: null,
    recommendedFor: ['tortoise_dry_small', 'box_turtle'],
    amazonIdentity: 'AMAZON_IDENTITY_VERIFIED',
    sizeStatus: 'PARTIALLY_EVALUATED',
    sizeNote: 'メーカー: Zoo Med（国内: ズーメッドジャパン）。型番 RRB-11。外寸 25.4×20.4×5.8cm（国内販売店）＝Zoo Med 公式 10×8×2.25in と一致。内寸・スロープ角は未確認。Zoo Med 公式の対象は「トカゲ・小型リクガメ」。XL（RRB-12・Amazon 実体は URL 照合済み）は箱亀・リクガメ向けだが外寸が資料間で不一致（33×23×6cm / 25.4×24×7cm）のため未採用',
  ...
  waterdish_sanko_dish: {
    ...
    asin: null,
    image: '/assets/products/placeholder.webp',
    why: '「SANKO レプタイルディッシュ」という商品は存在しない（2026-09-08 確認）ため名称を改めた。アカアシ成体（甲長30cm超）や森林性種が全身で浸かれる浅い水場は市販の爬虫類用水入れでは足りず、深さ2〜3cmのトレー・衣装ケース等を甲長に合わせて用意する。小型個体の飲み水にはレプティランプボウルなどを使う',
    rating: null,
    badge: null,
    recommendedFor: [],
  ...
  hydrometer_tetra: {
    ...
    recommendedFor: ['semi_aquatic_medium'],
    rakutenUrl: 'https://hb.afl.rakuten.co.jp/hgc/g00uw3xn.nhbnn1a9.g00uw3xn.nhbno0a2/?pc=https%3A%2F%2Fitem.rakuten.co.jp%2Fsproutsllc%2Fs-b09t3g3917-20260802%2F&m=http%3A%2F%2Fm.rakuten.co.jp%2Fsproutsllc%2Fi%2F10064899%2F&rafcid=wsc_i_is_fa8391ab-300d-4c4c-be83-ca2ddfdc47be',
    rakutenStatus: 'available',
    rakutenItemCode: 'sproutsllc:10064899',
    rakutenPrice: 1972,
    rakutenShop: 'スプラウツLLC 楽天市場店',
    rakutenConfidence: 4.2,
    rakutenLastUpdated: '2026-09-07',
    rakutenImageUrl: 'https://thumbnail.image.rakuten.co.jp/@0_mall/sproutsllc/cabinet/n20260802132715/b09t3g3917-1.jpg?_ex=128x128',
  },
};
